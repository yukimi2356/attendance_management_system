            ...
            <tbody>
                ...
                <c:forEach var="attendance" items="${attendances}" varStatus="status">
                    <tr class="row${status.count % 2}">
                        <td class="attendance_action"><a href="<c:url value='?action=${actAtd}&command=${commEdit}&id=${attendance.id}' />"><c:out value= '${attendance.date}' /></a></td>
                        <td><c:out value="${attendance.scheduledHours}" /></td>
